...
namespace Application.Features.Reports.GetExpenseStatusSummaryCompany
{
    public class GetExpenseStatusSummaryCompanyQuery : IRequest<List<GetExpenseStatusSummaryCompanyResponse>>
    {
